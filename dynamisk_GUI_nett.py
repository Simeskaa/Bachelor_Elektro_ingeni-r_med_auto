...
class Dialog(QDialog):
    def __init__(self):
       ...
       #Lage 3 "sonan", fuste sone e widgetan så kan rotera, 2 sone e knappan, 3 sone e vertikal/horisontal
    ...
    def buttons_orientation_changed(self, index): #Det e her selve orientation forandringen skjer
    ...
    def show_help(self): # Lage tekst når du trykke på help. func blir kalt opp i knappe koden
    ...
    def create_options_group_box(self): # detta så lage widgetan te vertical te horisontal
    ...
    def create_button_box(self): #Lage alle knappan
