...
int main () 
{
   ...
   }
   {
      ...
      print("\r\n Running Interrupt Test  for xadc_wiz_0...\r\n");

      Status = SysMonIntrExample(&intc, &xadc_wiz_0_SysMon_ADC, \
                                 XPAR_XADC_WIZ_0_DEVICE_ID, \
                                 XPAR_MICROBLAZE_0_AXI_INTC_XADC_WIZ_0_IP2INTC_IRPT_INTR, \
                                 &Temp);
