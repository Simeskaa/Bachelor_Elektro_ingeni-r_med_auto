...
//--------------------------------------------------------------------------------
//Command: generate_target bd_aa08.bd
//Design : bd_aa08
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_aa08,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_aa08,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "eth_mac_test_axi_ethernet_0_0.hwdef" *) 
module bd_aa08
   (axi_rxd_arstn,
    axi_rxs_arstn,
    axi_txc_arstn,
  ...
  bd_aa08_mac_0 mac
       (.glbl_rstn(eth_buf_RESET2TEMACn),
        ...
        .tx_mac_aclk(mac_tx_mac_aclk),
        .tx_reset(mac_tx_reset));
  bd_aa08_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(s_axi_lite_resetn_1),
        .Res(util_vector_logic_0_Res));
  bd_aa08_xlconstant_0_0 xlconstant_0
